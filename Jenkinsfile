    ...
    withSonarQubeEnv('sonarqube') { // If you have configured more than one global server connection, you can specify its name
      def scannerHome1 = bat "cd ${scannerHome}/bin"
       // echo $scannerHome1
        ...
        sonar-scanner -Dsonar.projectKey=deepak_micro -Dsonar.projectVersion=1.0 -Dsonar.sources="C:\\Program Files (x86)\\Jenkins\\workspace\\pipeline_one\\src\\main\\java"     
         """ 
    }
  }
}
